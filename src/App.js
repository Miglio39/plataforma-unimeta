...
const datosSedes = {
  ...
  'auditorio-mayor.webp': { nombre: 'Julio Flórez Roa 1 (Aula Magna)', categoria: 'Auditorios', descripcion: 'Espacio de gran capacidad destinado a ceremonias solemnes, conferencias magistrales y actos culturales centrales.', vistaExterior: '/assets/panoramas/exterior.RYL.webp', mapaUrl: enlaceSanFernando },
  'auditorio-bloquea.webp': { nombre: ' Julio Flórez Roa 2', categoria: 'Auditorios', descripcion: 'Auditorio alterno equipado con sistemas de proyección acústica para ponencias y eventos de facultades.', vistaExterior: '/assets/panoramas/exterior.RYL.webp', mapaUrl: enlaceSanFernando },
